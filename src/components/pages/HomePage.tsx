  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative w-full max-w-[120rem] mx-auto min-h-screen flex items-center">
        ...
        {/* Navigation */}
        <nav className="absolute top-0 left-0 right-0 z-20 p-6 bg-white/95 border-b border-primary/10">
          <div className="max-w-[100rem] mx-auto flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              <Link to="/" className="text-primary hover:text-primary/70 transition-all duration-300 font-paragraph relative group">
                Home
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
              </Link>
              <Link to="/funds" className="text-primary hover:text-primary/70 transition-all duration-300 font-paragraph relative group">
                Funds
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
              </Link>
              <Link to="/investor-resources" className="text-primary hover:text-primary/70 transition-all duration-300 font-paragraph relative group">
                Investor
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
              </Link>
              <Link to="/aum-details" className="text-primary hover:text-primary/70 transition-all duration-300 font-paragraph relative group">
                AUM
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
              </Link>
              <Link to="/contact" className="text-primary hover:text-primary/70 transition-all duration-300 font-paragraph relative group">
                About
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
              </Link>
            </div>
        ...
        <div className="relative z-10 max-w-[100rem] mx-auto px-6 text-center pt-24 md:pt-32">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg font-paragraph mb-4 tracking-wide text-white md:text-base lg:text-lg bg-black/30 backdrop-blur-sm px-4 py-2 rounded-lg inline-block border border-white/20">
            ...
            <p className="text-xl font-paragraph mb-8 leading-relaxed text-white/90">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild className="bg-primary hover:bg-primary/80 text-primary-foreground px-8 py-3 text-lg border border-primary transition-all duration-300">
                <Link to="/mutual-funds">Explore Our Funds</Link>
              </Button>
              <Button variant="outline" asChild className="border-white text-white hover:bg-white hover:text-primary px-8 py-3 text-lg transition-all duration-300 backdrop-blur-sm">
        ...
        <div className="max-w-[100rem] mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="bg-primary w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-xl transition-all duration-300">
                <TrendingUp className="w-8 h-8 text-primary-foreground" />
              </div>
              <h3 className="font-heading text-xl font-bold text-secondary-foreground mb-4 group-hover:text-primary transition-colors duration-300">
                Proven Performance
              </h3>
      ...
      <section className="py-20 bg-primary relative overflow-hidden">
        <div className="max-w-[100rem] mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="group">
              <div className="text-5xl font-heading font-bold text-primary-foreground mb-4 group-hover:scale-110 transition-transform duration-300">
                ₹40 Lakh+
              </div>
      ...
      <section className="py-20 bg-secondary relative overflow-hidden">
        <div className="max-w-[100rem] mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" asChild className="border-primary text-primary hover:bg-primary hover:text-primary-foreground px-8 py-3 text-lg transition-all duration-300">
      ...
      <section className="py-8 bg-background">
        <div className="max-w-[100rem] mx-auto px-6">
          <div className="bg-secondary rounded-lg shadow-lg border border-primary/20 p-6 text-center">
      ...
      {/* Footer */}
      <footer className="bg-primary text-primary-foreground py-12 border-t border-primary/20 relative overflow-hidden">
        <div className="max-w-[100rem] mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="font-heading text-lg font-semibold mb-4">Quick Links</h4>
              <ul className="space-y-2 font-paragraph">
                <li><Link to="/mutual-funds" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-300">Mutual Funds</Link></li>
                <li><Link to="/investor-resources" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-300">Investor Resources</Link></li>
                <li><Link to="/aum-details" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-300">AUM Details</Link></li>
                <li><Link to="/contact" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-300">Contact Us</Link></li>
              </ul>
            </div>
            <div>
